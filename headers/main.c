...
int main() {
    ...
    char *gps_data[7]; char *b_lat =NULL , *b_long=NULL ;


    gps_data[0]=",,,,,,,,,,,,,,";
    gps_data[1]="$GPGGA,002153.000,30.065381,N,31.276990,W,1,05,2.68,129.0,M,50.1,M,,*42";
    gps_data[2]="$GPGGA,002153.000,30.065632,N,31.277625,W,1,05,2.68,129.0,M,50.1,M,,*42";
    gps_data[3]="$GPGGA,002153.000,30.065827,N,31.278272,W,1,05,2.68,129.0,M,50.1,M,,*42";
    gps_data[4]="$GPGGA,002153.000,30.065988,N,31.278778,W,1,05,2.68,129.0,M,50.1,M,,*42";
    gps_data[5]="$GPGGA,002153.000,30.066205,N,31.279398,W,1,05,2.68,129.0,M,50.1,M,,*42";
    gps_data[6]="$GPGGA,002153.000,30.066322,N,31.279786,W,1,05,2.68,129.0,M,50.1,M,,*42";
